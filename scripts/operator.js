...
let x;
const y = '20';
console.log(x,y) //x 값이 정이 안됨(undefined) , '20'
console.log(y+b); //201
//y 초기화하고 싶다 - > 불가능 ->const 상수
x = '10'; //정의안됨 -> 문자 10 대입
console.log(x+y); //1020
x = null; //x 변수의 값을 초기화한다.
console.log(x+y); //null20
console.log(x+a); // 1
console.log('-----------------------------------------------------------------------------------')
//log(),typeof()
//prompt() 질문, 답변 창을 듸우는 함수(문자열로 인식)
//Number()
//괄호 안의 데이터를 숫자로 변환하는 함수
//1+4=?
//유치원생 대상 두수를 더하는 문제 프로그래밍
const num1 = Number(prompt('첫번째 수를 입력하세요.'));
// 1. const num1 상수 생성
// 2. prompt() 질문하고 사용자에게 문자열 답변 받고
// 3. Number() 문자열을 숫자로 변환 완료
// 4. 대입 연산자로 num1 대입완료
